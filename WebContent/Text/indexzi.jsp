        ...
        <div class="banner-area">
            <div class="row row--0">
                ...
                <div class="col-lg-4 col-md-6 col-12 mt_sm--30">
                    <div class="banner">
                        <div class="thumbnail">
                            <img src="../OneStatic/assets/images/banner/banner-01.jpg" alt="Banner Images">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-12 mt_sm--30">
                    <div class="banner">
                        <div class="thumbnail">
                            <img src="../OneStatic/assets/images/banner/banner-02.jpg" alt="Banner Images">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-12 mt_md--30 mt_sm--30">
                    <div class="banner">
                        <div class="thumbnail">
                            <img src="../OneStatic/assets/images/banner/banner-03.jpg" alt="Banner Images">
                        </div>
                        <div class="content">
                ...
                <div class="row mt--20">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                        <div class="product">
                            ...
                            <div class="content">
                                <h2><a href="product-details.jsp">Matchbox’ Fit Jeans</a></h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                        <div class="product">
                            ...
                            <div class="content">
                                <h2><a href="product-details.jsp">Fit Wool Suit</a></h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                        <div class="product">
                            ...
                            <div class="content">
                                <h2><a href="product-details.jsp">Three-Piece Checke</a></h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                                        <div class="product">
                                            ...
                                            <div class="content">
                                                <h2><a href="product-details.jsp">Wool Crewneck Sweater</a></h2>
                                                <span class="prize">$200.00</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                                        <div class="product">
                                            ...
                                            <div class="content">
                                                <h2><a href="product-details.jsp">Demo Product Name</a></h2>
                                                <span class="prize">$200.00</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                                        <div class="product">
                                            ...
                                            <div class="content">
                                                <h2><a href="product-details.jsp">Three-Piece Check</a></h2>
                                                <span class="prize">$200.00</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                                        <div class="product">
                                            ...
                                            <div class="content">
                                                <h2><a href="product-details.jsp">Mixed Media Top</a></h2>
                                                <span class="prize">$200.00</span>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12 mt_sm--40">
                        ...
                        <div class="best-rating-product">
                            ...
                            <div class="content">
                                <h6><a href="product-details.jsp">Variable product</a></h6>
                                <div class="price">
                        ...
                        <div class="best-rating-product mt--30">
                            ...
                            <div class="content">
                                <h6><a href="product-details.jsp">Demo Product Name</a></h6>
                                <div class="price">
                                    <span class="theme-color">$25.22</span>
                                    <span class="old-price">$30.00</span>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12 mt_md--40">
                        ...
                        <div class="best-rating-product">
                            ...
                            <div class="content">
                                <h6><a href="product-details.jsp">Fit Wool Suit</a></h6>
                                <div class="price">
                                    <span class="theme-color">$25.22</span>
                                    <span class="old-price">$30.00</span>
                                </div>
                        ...
                        <div class="best-rating-product mt--30">
                            ...
                            <div class="content">
                                <h6><a href="product-details.jsp">Matchbox’ Fit Jeans</a></h6>
                                <div class="price">
                                    <span class="theme-color">$25.22</span>
                                    <span class="old-price">$30.00</span>
                                </div>
