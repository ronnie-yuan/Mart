...
public class MartCarDao {
	...
	public List<Cartproduct> FindListByUserId(Integer userId) {
		// 1.定义sql语句
		String sql="select p.proId,proImg,  proName,  proPrice,  ccount   from  c_user, c_cart, c_product p where c_user.userId=c_cart.userId and c_cart.proId=p.proId and c_user.userId=?";
		//2.设置参数集合
