                        ...
                        <form action="#">
                            <div class="cart-table table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="pro-thumbnail"><a href="#"><img src="OneStatic/assets/images/product/product-01.jpg" alt="Product"></a></td>
                                            <td class="pro-title"><a href="#">Sample Bundle Product</a></td>
                                        ...
                                        <tr>
                                            <td class="pro-thumbnail"><a href="#"><img src="OneStatic/assets/images/product/product-02.jpg" alt="Product"></a></td>
                                            <td class="pro-title"><a href="#">Matchbox’ Fit Jeans</a></td>
                                        ...
                                        <tr>
                                            <td class="pro-thumbnail"><a href="#"><img src="OneStatic/assets/images/product/product-03.jpg" alt="Product"></a></td>
                                            <td class="pro-title"><a href="#">Variable product</a></td>
                                            <td class="pro-price"><span>$295.00</span></td>
                                            <td class="pro-quantity">
                                                <div class="pro-qty"><input type="text" value="1"></div>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="pro-thumbnail"><a href="#"><img src="OneStatic/assets/images/product/product-04.jpg" alt="Product"></a></td>
                                            <td class="pro-title"><a href="#">Open Front Cardigan</a></td>
