...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner text-center">
                        <h2 class="font--40 mb--0">Compare</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="main-wrapper">
        ...
        <!-- Compare Page Start -->
        <div class="compare_area ptb--120 ptb_md--80 ptb_sm--80 bg-color" data-bg-color="#ffffff">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <form action="#">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="product-image-title">
                                                <a href="#" class="image"><img src="OneStatic/assets/images/product/product-10.jpg" alt="Compare Product"></a>
                                                <a href="#" class="category">Dress</a>
                                                <a href="#" class="title">Demo Product Name</a>
                                            </td>
                                            <td class="product-image-title">
                                                <a href="#" class="image"><img src="OneStatic/assets/images/product/product-11.jpg" alt="Compare Product"></a>
                                                <a href="#" class="category">Dress</a>
                                                <a href="#" class="title">Demo Product Name</a>
                                            </td>
                                            <td class="product-image-title">
                                                <a href="#" class="image"><img src="OneStatic/assets/images/product/product-12.jpg" alt="Compare Product"></a>
                                                <a href="#" class="category">Dress</a>
                                                <a href="#" class="title">Demo Product Name</a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pro-addtocart"><a href="#" class="add-to-cart" tabindex="0"><i
                                                        class="fa fa-cart-plus"></i><span>ADD TO CART</span></a></td>
                                            <td class="pro-addtocart"><a href="#" class="add-to-cart" tabindex="0"><i
                                                        class="fa fa-cart-plus"></i><span>ADD TO CART</span></a></td>
                                            <td class="pro-addtocart"><a href="#" class="add-to-cart" tabindex="0"><i
                                                        class="fa fa-cart-plus"></i><span>ADD TO CART</span></a></td>
