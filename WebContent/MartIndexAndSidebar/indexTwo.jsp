...
<body>
    ...
    <!-- Start Banner Area 页面开始-->
    <div class="slider-activation">
    	<!-- Start Single Slide -->
        <div class="slider-area ptb--150 bg_image bg_image--8 fullscreen d-flex align-items-center">
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 offset-xl-8 col-lg-6 offset-lg-6">
                        <div class="slide-content">
                            <img src="OneStatic/assets/images/logo/text.png" alt="Text">
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                            <div class="shop-now-btn">
                                <button type="button">Shop Now <i class="fa fa-arrow-right"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- End Single Slide -->
    	<!-- Start Single Slide -->
        <div class="slider-area ptb--150 bg_image bg_image--7 fullscreen d-flex align-items-center">
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 offset-xl-8 col-lg-6 offset-lg-6">
                        <div class="slide-content">
        ...
        <!-- End Single Slide -->
    	<!-- Start Single Slide -->
        <div class="slider-area ptb--150 bg_image bg_image--2 fullscreen d-flex align-items-center">
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 offset-xl-8 col-lg-6 offset-lg-6">
                        <div class="slide-content">
        ...
        <!-- End Single Slide -->
        <!-- Start Single Slide -->
        <div class="slider-area ptb--150 bg_image bg_image--5 fullscreen d-flex align-items-center">
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 offset-xl-8 col-lg-6 offset-lg-6">
                        <div class="slide-content">
        ...
        <!-- End Single Slide -->
        <!-- Start Single Slide -->
        <div class="slider-area ptb--150 bg_image bg_image--6 fullscreen d-flex align-items-center">
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 offset-xl-8 col-lg-6 offset-lg-6">
                        <div class="slide-content">
        ...
        <div class="banner-area">
            <div class="row row--0">
                ...
                <div class="col-lg-4 col-md-6 col-12 mt_sm--30">
                    <div class="banner">
                        <div class="thumbnail">
                            <img src="https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=1910932285,462253340&fm=27&gp=0.jpg" alt="Banner Images">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-12 mt_sm--30">
                    <div class="banner">
                        <div class="thumbnail">
                            <img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1561388064480&di=7648d3bcc333f8b87c2dc5636ce859e9&imgtype=0&src=http%3A%2F%2Fimg2.zol.com.cn%2Fproduct%2F109%2F154%2Fcef7QaRaJDc.jpg" alt="Banner Images">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-12 mt_md--30 mt_sm--30">
                    <div class="banner">
                        <div class="thumbnail">
                            <img src="https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=1701225435,1955946949&fm=26&gp=0.jpg" alt="Banner Images">
                        </div>
                        <div class="content">
                ...
                <div class="row mt--20">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                        <div class="product">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">
                                        <img src="OneStatic/assets/images/product/product-16.jpg" alt="Product Images">
                                    </a>
                                </div>
                            ...
                            <div class="content">
                                <h2><a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">Matchbox’ Fit Jeans</a></h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                        <div class="product">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">
                                        <img src="OneStatic/assets/images/product/product-15.jpg" alt="Product Images">
                                    </a>
                                </div>
                                <div class="product-hover-action">
                                    <div class="hover-inner">
                            ...
                            <div class="content">
                                <h2><a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">Fit Wool Suit</a></h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                        <div class="product">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">
                                        <img src="OneStatic/assets/images/product/product-14.jpg" alt="Product Images">
                                    </a>
                                </div>
                                <div class="product-hover-action">
                                    <div class="hover-inner">
                            ...
                            <div class="content">
                                <h2><a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">Three-Piece Checke</a></h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                        <div class="product">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">
                                        <img src="OneStatic/assets/images/product/product-13.jpg" alt="Product Images">
                                    </a>
                                </div>
                                <div class="product-hover-action">
                                    <div class="hover-inner">
                            ...
                            <div class="content">
                                <h2><a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">Open Front Cardigan</a></h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                                        <div class="product">
                                            ...
                                            <div class="content">
                                                <h2><a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">Variable product</a></h2>
                                                <span class="prize">$200.00</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                                        <div class="product">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">
                                                        <img src="OneStatic/assets/images/product/product-05.jpg" alt="Product Images">
                                                    </a>
                                                </div>
                                                <div class="product-hover-action">
                                                    <div class="hover-inner">
                                            ...
                                            <div class="content">
                                                <h2><a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">Wool Crewneck Sweater</a></h2>
                                                <span class="prize">$200.00</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                                        <div class="product">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">
                                                        <img src="OneStatic/assets/images/product/product-06.jpg" alt="Product Images">
                                                    </a>
                                                </div>
                                                <div class="product-hover-action">
                                                    <div class="hover-inner">
                                            ...
                                            <div class="content">
                                                <h2><a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">Demo Product Name</a></h2>
                                                <span class="prize">$200.00</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                                        <div class="product">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">
                                                        <img src="OneStatic/assets/images/product/product-07.jpg" alt="Product Images">
                                                    </a>
                                                </div>
                                                <div class="product-hover-action">
                                                    <div class="hover-inner">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                                        <div class="product">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">
                                                        <img src="OneStatic/assets/images/product/product-08.jpg" alt="Product Images">
                                                    </a>
                                                </div>
                                                <div class="product-hover-action">
                                                    <div class="hover-inner">
                                            ...
                                            <div class="content">
                                                <h2><a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">Three-Piece Check</a></h2>
                                                <span class="prize">$200.00</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                                        <div class="product">
                                            ...
                                            <div class="content">
                                                <h2><a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">Sample Bundle Product</a></h2>
                                                <span class="prize">$200.00</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                                        <div class="product">
                                            ...
                                            <div class="content">
                                                <h2><a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">Mixed Media Top</a></h2>
                                                <span class="prize">$200.00</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                                        <div class="product">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">
                                                        <img src="OneStatic/assets/images/product/product-12.jpg" alt="Product Images">
                                                    </a>
                                                </div>
                                                <div class="product-hover-action">
                                                    <div class="hover-inner">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                                        <div class="product">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">
                                                        <img src="OneStatic/assets/images/product/product-11.jpg" alt="Product Images">
                                                    </a>
                                                </div>
                                                <div class="product-hover-action">
                                                    <div class="hover-inner">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                                        <div class="product">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">
                                                        <img src="OneStatic/assets/images/product/product-10.jpg" alt="Product Images">
                                                    </a>
                                                </div>
                                                <div class="product-hover-action">
                                                    <div class="hover-inner">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                                        <div class="product">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">
                                                        <img src="OneStatic/assets/images/product/product-09.jpg" alt="Product Images">
                                                    </a>
                                                </div>
                                                <div class="product-hover-action">
                                                    <div class="hover-inner">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="banner">
                            <div class="thumbnail">
                                <img class="w-100" src="OneStatic/assets/images/banner/banner-04.jpg" alt="Banner Images">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12 mt_sm--40">
                        ...
                        <div class="best-rating-product">
                            ...
                            <div class="content">
                                <h6><a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">Variable product</a></h6>
                                <div class="price">
                        ...
                        <div class="best-rating-product mt--30">
                            ...
                            <div class="content">
                                <h6><a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">Demo Product Name</a></h6>
                                <div class="price">
                                    <span class="theme-color">$25.22</span>
                                    <span class="old-price">$30.00</span>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12 mt_md--40">
                        ...
                        <div class="best-rating-product">
                            <div class="thumb">
                                <a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">
                                    <img src="OneStatic/assets/images/product/sm-product-04.jpg" alt="Product">
                                </a>
                            </div>
                            <div class="content">
                                <h6><a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">Fit Wool Suit</a></h6>
                                <div class="price">
                                    <span class="theme-color">$25.22</span>
                                    <span class="old-price">$30.00</span>
                                </div>
                        ...
                        <div class="best-rating-product mt--30">
                            <div class="thumb">
                                <a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">
                                    <img src="OneStatic/assets/images/product/sm-product-05.jpg" alt="Product">
                                </a>
                            </div>
                            <div class="content">
                                <h6><a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">Fit Wool Suit</a></h6>
                        ...
                        <div class="best-rating-product mt--30">
                            ...
                            <div class="content">
                                <h6><a href="IndexServlet?actionName=changePage&changePage=MartProDetails/product-details.jsp">Matchbox’ Fit Jeans</a></h6>
                                <div class="price">
                                    <span class="theme-color">$25.22</span>
                                    <span class="old-price">$30.00</span>
                                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="brand-wrapper bg-color ptb--70" data-bg-color="#f7f8f9">
                            <div class="brand-list plr--60 flex-wrap flex-lg-nowrap d-flex justify-content-between">
                                <a href="#">
                                    <img src="OneStatic/assets/images/brand/brand-01.png" alt="Brand">
                                </a>
                                <a href="#">
                                    <img src="OneStatic/assets/images/brand/brand-02.png" alt="Brand">
                                </a>
                                <a href="#">
                                    <img src="OneStatic/assets/images/brand/brand-03.png" alt="Brand">
                                </a>
                                <a href="#">
                                    <img src="OneStatic/assets/images/brand/brand-04.png" alt="Brand">
                                </a>
                                <a href="#">
                                    <img src="OneStatic/assets/images/brand/brand-01.png" alt="Brand">
                                </a>
