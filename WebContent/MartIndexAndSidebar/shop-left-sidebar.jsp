            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner text-center">
                        <h2 class="font--40 mb--0">Shop Left Sidebar</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                            ...
                            <div class="shop-sidebar-wrapper">
                                ...
                                <div class="shop-sidebar related-product-inner mt--50">
                                    ...
                                    <ul class="related-product">
                                        <!-- Start Single Product 左侧查询框 -->
                                        <li>
                                            <div class="product-item">
                                                <div class="thumbnail">
                                                    <a href="single-product.jsp">
                                                        <img src="OneStatic/assets/images/product/sm-product-01.jpg" alt="multi-purpose">
                                                    </a>
                                                </div>
                                                <div class="info">
                                                    <h5 class="heading heading-h5"><a href="single-product.jsp">Open Front Cardigan</a></h5>
                                                    <ul class="rating">
                                                    ...
                                                    <div class="price"><span>$58.00</span> <span
                                                            class="new-price">$70.00</span></div>
                                                </div>
                                            </div>
                                        </li>
                                        <!-- End Single Product -->
                                        ...
                                        <li>
                                            <div class="product-item">
                                                <div class="thumbnail">
                                                    <a href="single-product.jsp">
                                                        <img src="OneStatic/assets/images/product/sm-product-02.jpg" alt="multi-purpose">
                                                    </a>
                                                </div>
                                                <div class="info">
                                                    <h5 class="heading heading-h5"><a href="single-product.jsp">Open Front Cardigan</a></h5>
                                                    <div class="price"><span>$89.00</span> <span
                                                            class="new-price">$58.00</span></div>
                                                </div>
                                            </div>
                                        </li>
                                        <!-- End Single Product -->
                                        ...
                                        <li>
                                            <div class="product-item">
                                                <div class="thumbnail">
                                                    <a href="single-product.jsp">
                                                        <img src="OneStatic/assets/images/product/sm-product-03.jpg" alt="multi-purpose">
                                                    </a>
                                                </div>
                                                <div class="info">
                                                    <h5 class="heading heading-h5"><a href="single-product.jsp">Variable product</a></h5>
                                                    <div class="price"><span>$89.00</span> <span
                                                            class="new-price">$58.00</span></div>
                                                </div>
                                            </div>
                                        ...
                                        <li>
                                            <div class="product-item">
                                                ...
                                                <div class="info">
                                                    <h5 class="heading heading-h5"><a href="single-product.jsp">Matchbox’ Fit Jeans</a></h5>
                                                    <ul class="rating">
                                                        <li><i class="fa fa-star"></i></li>
                                                        <li><i class="fa fa-star"></i></li>
                                                        <li><i class="fa fa-star"></i></li>
                                ...
                                <!-- End Single Widget -->
                                <!-- Start Single Widget -->
                                <div class="shop-sidebar nwinstagram mt--50">
                                    ...
                                    <div class="instagram-grid-wrap instagram-grid-5 inner">
                                        ...
                                        <div class="item-grid grid-style--1">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="OneStatic/assets/images/product/sm-product-01.jpg" alt="instagram images">
                                                </a>
                                                <div class="item-info">
                                                    <div class="inner">
                                                        <a href="#"><i class="fa fa-heart-o"></i>1k</a>
                                                        <a href="#"><i class="fa fa-comments"></i>9</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="item-grid grid-style--1">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="OneStatic/assets/images/product/sm-product-02.jpg" alt="instagram images">
                                                </a>
                                                <div class="item-info">
                                                    <div class="inner">
                                                        <a href="#"><i class="fa fa-heart-o"></i>4k</a>
                                                        <a href="#"><i class="fa fa-comments"></i>9</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="item-grid grid-style--1">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="OneStatic/assets/images/product/sm-product-03.jpg" alt="instagram images">
                                                </a>
                                                <div class="item-info">
                                                    <div class="inner">
                                                        <a href="#"><i class="fa fa-heart-o"></i>1k</a>
                                        ...
                                        <div class="item-grid grid-style--1">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="OneStatic/assets/images/product/sm-product-04.jpg" alt="instagram images">
                                                </a>
                                                <div class="item-info">
                                                    <div class="inner">
                                                        <a href="#"><i class="fa fa-heart-o"></i>1k</a>
                                        ...
                                        <div class="item-grid grid-style--1">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="OneStatic/assets/images/product/sm-product-05.jpg" alt="instagram images">
                                                </a>
                                                <div class="item-info">
                                                    <div class="inner">
                                                        <a href="#"><i class="fa fa-heart-o"></i>1k</a>
                    ...
                    <div class="order-1 order-lg-2 col-lg-8">
                        ...
                        <!-- Start Shop Minimal Product 中间显示商品-->
                        <div class="shop-minimal-product">
                            <div class="row row--25">
                                
                                <c:if test="${empty resultInfo.getResult() }">
                               		<li><span>无数据</span></li>
                               	</c:if>
                               	<c:if test="${!empty resultInfo.getResult() }">
                               		<c:forEach items="${resultInfo.getResult() }" var="list">
                               			...
                               			<div class="col-lg-4 col-md-6 col-sm-6 col-12 mt--60">
		                                    <div class="product">
		                                        ...
		                                        <div class="content">
		                                            <h2><a href="product-details.jsp">${list.getProName() }</a></h2>
		                                            <span class="prize">${list.getProPrice() } $</span>
		                                        </div>
		                                    </div>
		                                </div>
                        ...
                        <!-- End Shop Minimal Product 中间显示商品结束-->
                    </div>
                </div>
            </div>
        </div>
