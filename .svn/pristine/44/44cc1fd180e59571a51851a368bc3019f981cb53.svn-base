                                 ...
                                 <!-- 
                                    ...
                                    <c:if test="${resultInfo.result !=null }">
                                    	<c:forEach items="${resultInfo.result }" var="order">
                                    		<tr id="tr_${order.orderId}" ><input type="hidden" id="oId" value="${list.orderId}" />
	                                        ...
	                                        <td> <button type="button" id="btn" class="btn btn-success" onclick="showModal(${order.orderId})">修改</button>
	                                        &nbsp;&nbsp;
	                                        <button type="button" id="btn" class="btn btn-warning" onclick="comfirmDelete(${order.orderId})">删除</button></td>
	                                    	</tr>
